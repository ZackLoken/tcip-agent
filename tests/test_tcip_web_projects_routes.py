...
def test_list_reports_site_fields_across_four_project_states(client, workspace_dir):
    ...
    assert set(by_name) == {
        "hazelnut_catkin_recorded", "hazelnut_catkin_recordless",
        "hazelnut_catkin_undecodable", "hazelnut_catkin_invalid",
    }
    ...
    assert "does not decode" in by_name["hazelnut_catkin_undecodable"]["site_problem"]

    assert by_name["hazelnut_catkin_invalid"]["site"] is None
    assert "does not hold a site" in by_name["hazelnut_catkin_invalid"]["site_problem"]
