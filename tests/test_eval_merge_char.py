...
GOLDEN_DETECTIONS = {
    ...
    "conf_threshold": 0.5,
    "matches": {
        "tp": [{"gt_idx": 0, "pred_idx": 0, "iou": 1.0, "class_name": "catkin", "conf": 0.9}],
        "fp": [{"pred_idx": 1, "class_name": "catkin", "conf": 0.7}],
        "fn": [{"gt_idx": 1, "class_name": "catkin"}],
    },
    "img_w": 640,
    "img_h": 480,
    "detections": [
        {"tag": "tp", "class_name": "catkin", "iou": 1.0, "confidence": 0.9,
         "gt_idx": 0, "pred_idx": 0, "box": [288.0, 216.0, 64.0, 48.0]},
        {"tag": "fp", "class_name": "catkin", "confidence": 0.7, "pred_idx": 1,
         "box": [496.0, 372.0, 32.0, 24.0]},
        {"tag": "fn", "class_name": "catkin", "confidence": 0, "gt_idx": 1,
