"""K2 — dedicated coverage for the new/changed gate conditions in ``resolve_operating_point``:
...
from tcip_mcp.traits import CATKIN, DETECTION_F1, PRESENCE, TraitSpec  # noqa: E402
...
# test_char_goldens_measurement.py / test_k1_review_fixes.py / test_review_calibration.py /
# test_operating_point_gates_k2.py's own integration fixture above) has EXACTLY ZERO per-image
