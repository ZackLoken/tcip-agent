...
It behaves like any TUI-ish CLI under a PTY: prints a banner, echoes each input line
back with a marker, and exits on ``exit``. Cross-platform (runs under ConPTY on
Windows and a POSIX pty on CI).
"""
