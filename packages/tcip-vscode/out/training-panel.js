...
exports.TrainingPanel = void 0;
const webview_base_1 = require("./webview-base");
class TrainingPanel extends webview_base_1.WebviewPanelProvider {
    constructor(extensionUri) {
        super(extensionUri, "tcip-training", "TCIP: Training");
    }
    getHtmlContent(webview, nonce, sharedCssUri, sharedJsUri) {
        const trainingJsUri = (0, webview_base_1.getUri)(webview, this.extensionUri, "media", "training.js");
        const chartJsUri = (0, webview_base_1.getUri)(webview, this.extensionUri, "node_modules", "chart.js", "dist", "chart.umd.js");
...
exports.TrainingPanel = TrainingPanel;
//# sourceMappingURL=training-panel.js.map