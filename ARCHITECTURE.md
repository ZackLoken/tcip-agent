...
Source: the module inventory `tools/build_module_inventory.py` produces, run at HEAD 6559de15.
...
HEAD 6559de15 has 434 modules across the six scanned roots (141702 total lines):
