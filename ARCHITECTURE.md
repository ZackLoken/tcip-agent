...
Source: the module inventory `tools/build_module_inventory.py` produces, run at HEAD d3557ec9.
...
HEAD d3557ec9 has 434 modules across the six scanned roots (141357 total lines):
