...
Source: the module inventory `tools/build_module_inventory.py` produces, run at HEAD a51eac27.
...
HEAD a51eac27 has 435 modules across the six scanned roots (145085 total lines):
