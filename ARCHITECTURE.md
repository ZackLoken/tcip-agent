...
| packages/tcip-mcp/src/tcip_mcp/project_paths.py | Stable resolution of the platform state root, independent of a process's cwd. | 1 | 28 |
...
| packages/tcip-mcp/src/tcip_mcp/tools/knowledge_tools.py | The domain_knowledge MCP tool, the one non-Claude-Code-skill route to the knowledge documents; its description is composed at import time from the corpus itself. | 4 | 1 |
...
| packages/tcip-web/src/tcip_web/routes/results.py | Results routes: plant-mapping, per-plant phenology curves, CSV export, the operationalization record surface, the trait-spec statement surface, and the read-only delivery-event list. | 19 | 1 |
...
| tool | line | audited | docstring first line |
|---|---|---|---|
| `domain_knowledge` | `knowledge_tools.py:46` | yes | Read the platform's domain knowledge: trait semantics, workflow patterns, and per-crop |
...
| `compute_phenology` | `phenology_tools.py:536` | yes | Per-plant phenology milestones from classified predictions + a plant mapping. |  <!-- queued: P5-43 unify -->
...
| method | path | handler | line |
|---|---|---|---|
| GET | `/grid` | `get_grid` | `routes/coverage.py:188` |
| GET | `` (root) | `get_coverage` | `routes/coverage.py:230` |
| POST | `` (root) | `post_coverage` | `routes/coverage.py:280` |
| GET | `/completeness` | `get_completeness` | `routes/coverage.py:448` |
| POST | `/completeness` | `post_completeness` | `routes/coverage.py:622` |
...
| POST | `/plant_mapping/load` | `load_plant_mapping` | `routes/results.py:269` |
| GET | `/plant_mapping/list` | `list_plant_mappings` | `routes/results.py:303` |
| POST | `/phenology_measurement` | `phenology_measurement` | `routes/results.py:577` |
| POST | `/export_csv` | `export_csv` | `routes/results.py:633` |
| GET | `/traits` | `list_traits` | `routes/results.py:1083` |
| GET | `/operationalization` | `get_operationalization` | `routes/results.py:757` |
| GET | `/operationalizations` | `list_operationalizations` | `routes/results.py:773` |
| POST | `/operationalization/confirm` | `confirm_operationalization` | `routes/results.py:811` |
| GET | `/trait-spec-statement` | `get_trait_spec_statement` | `routes/results.py:913` |
| GET | `/trait-spec-statements` | `list_trait_spec_statements` | `routes/results.py:929` |
| POST | `/trait-spec-statement/confirm` | `confirm_trait_spec_statement` | `routes/results.py:971` |
| GET | `/delivery-events` | `list_delivery_events` | `routes/results.py:1044` |
| GET | `/models/registered` | `registered_models` | `routes/results.py:1112` |
...
| method | path | handler | line |
|---|---|---|---|
| POST | `/sweeps` | `relaunch_sweep` | `routes/tuning.py:517` |
| POST | `/sweeps/{sweep_id}/cancel` | `cancel_sweep_route` | `routes/tuning.py:557` |
| GET | `/sweeps` | `list_sweeps` | `routes/tuning.py:568` |
| GET | `/sweeps/{sweep_id}` | `get_sweep` | `routes/tuning.py:584` |
| GET | `/sweeps/{sweep_id}/trials` | `list_trials` | `routes/tuning.py:635` |
| GET | `/sweeps/{sweep_id}/trials/{trial_id}/metrics` | `get_trial_metrics` | `routes/tuning.py:668` |
| GET | `/ray-dashboard` | `get_ray_dashboard` | `routes/tuning.py:695` |
| POST | `/sweeps/{sweep_id}/tensorboard` | `launch_sweep_tensorboard` | `routes/tuning.py:781` |
| POST | `/sweeps/{sweep_id}/trials/{trial_id}/tensorboard` | `launch_trial_tensorboard` | `routes/tuning.py:798` |
| POST | `/sweeps/{sweep_id}/trials/{trial_id}/tensorboard/stop` | `stop_trial_tensorboard` | `routes/tuning.py:812` |
...
`pipelines/postprocessing/plant_mapping.py:1071` (`_require_receipt`)
...
Side B: `packages/tcip-annotation/src/tcip_annotation/sam_wrapper.py:329` (`def grid_to_rect(`, the one cell-name lookup, with `grid_to_pixel`, line 360, built on it) and `packages/tcip-web/src/tcip_web/routes/coverage.py:187` (`@router.get("/grid")`, `get_grid`, whose cell list the browser consumes verbatim).
Phase 3 verdict: single.
