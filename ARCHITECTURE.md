...
Source: the module inventory `tools/build_module_inventory.py` produces, run at HEAD 80394e29.
...
HEAD 80394e29 has 429 modules across the six scanned roots (138333 total lines):
