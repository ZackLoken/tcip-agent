...
Source: the module inventory `tools/build_module_inventory.py` produces, run at HEAD fdfd176c.
...
HEAD fdfd176c has 442 modules across the six scanned roots (138038 total lines):
