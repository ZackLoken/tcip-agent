...
Source: the module inventory `tools/build_module_inventory.py` produces, run at HEAD e1442264.
...
HEAD e1442264 has 435 modules across the six scanned roots (142972 total lines):
