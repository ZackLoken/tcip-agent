...
Source: the module inventory `tools/build_module_inventory.py` produces, run at HEAD 5edf4bf3.
...
HEAD 5edf4bf3 has 435 modules across the six scanned roots (144472 total lines):
