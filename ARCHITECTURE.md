...
Source: the module inventory `tools/build_module_inventory.py` produces, run at HEAD 71fd699e.
...
HEAD 71fd699e has 436 modules across the six scanned roots (145572 total lines):
