...
Source: the module inventory `tools/build_module_inventory.py` produces, run at HEAD 84b7de08.
...
HEAD 84b7de08 has 434 modules across the six scanned roots (140865 total lines):
