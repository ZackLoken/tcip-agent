...
Source: the module inventory `tools/build_module_inventory.py` produces, run at HEAD 8d4a65db.
...
HEAD 8d4a65db has 436 modules across the six scanned roots (145576 total lines):
