...
| packages/tcip-web/frontend/src/api/types.generated.ts | The coverage record's types, generated by scripts/generate_frontend_types.py from the pydantic models it renders (routes/_coverage_models.py, routes/coverage.py). | 0 | 4 |
...
| scripts/generate_frontend_types.py | Generate the browser's coverage-record types from the pydantic models that declare them. | 3 | 0 |
...
| POST | `/backup_labels` | `backup_labels` | `routes/review.py:710` |
| POST | `/save_gt` | `save_gt` | `routes/review.py:730` |
| POST | `/validate_reference` | `validate_reference` | `routes/review.py:780` |
...
`packages/tcip-web/src/tcip_web/routes/review.py:660`, derives it from the GT file through
